    ...
    <div id="outerBox">
        <div class="box active" id="box1">
            ...
            <div class="content">
                ...
                <!-- 右边整体的内容 -->
                <div class="dateLeftBox" style="top: 1.2rem;">
                    <h2>1988年</h2>
                    <div>
                        <p>发生的事件</p>
                ...
                <!-- 第二大块 -->
                <!-- 左边整体的内容 -->
                <div class="dateBox" style="top: 2.4rem;">
                    <h2>1990年</h2>
                    <div>
                        <p>发生的事件</p>
                ...
                <!-- 右边整体的内容 -->
                <div class="dateLeftBox" style="top: 3.6rem;">
                    <h2>1992年</h2>
                    <div>
                        <p>发生的事件</p>
...
《中国护理事业发展纲要（2011-2015）》首次将临终关怀纳入护理规划和长期医疗护理服务。</ul>
                ...
                <!-- 第三大块 -->
                <!-- 左边整体的内容 -->
                <div class="dateBox" style="top: 4.8rem;">
                    <h2>2012年</h2>
                    <div>
                        <p>发生的事件</p>
                ...
                <!-- 右边整体的内容 -->
                <div class="dateLeftBox" style="top: 6rem;">
                    <h2>2013年</h2>
                    <div>
                        <p>发生的事件</p>
                ...
                <!-- 第四大块 -->
                <!-- 左边整体的内容 -->
                <div class="dateBox" style="top: 7.2rem;">
                    <h2>2014年</h2>
                    <div>
                        <p>发生的事件</p>
                ...
                <!-- 右边整体的内容 -->
                <div class="dateLeftBox" style="top: 8.4rem;">
                    <h2>2015年</h2>
                    <div>
                        <p>发生的事件</p>
                ...
                <!-- 第五大块 -->
                <!-- 左边整体的内容 -->
                <div class="dateBox" style="top: 9.6rem;">
                    <h2>2016年4月</h2>
                    <div>
                        <p>发生的事件</p>
                ...
                <!-- 右边整体的内容 -->
                <div class="dateLeftBox" style="top: 10.8rem;">
                    <h2>2016年10月</h2>
                    <div>
                        <p>发生的事件</p>
...
推进安宁疗护试点工作。</ul>
                ...
                <!-- 第六大块 -->
                <!-- 左边整体的内容 -->
                <div class="dateBox" style="top: 12rem;">
                    <h2>2022年5月</h2>
                    <div>
                        <p>发生的事件</p>
...
5月，《“十四五”国民健康规划》指出，我国将稳步扩大全国安宁疗护试点，支持有条件的省市全面开展安宁疗护工作，完善安宁疗护服务模式，建立安宁疗护服务制度体系，提高老年人和疾病终末期患者生命质量。</ul>
                ...
                <!-- 右边整体的内容 -->
                <div class="dateLeftBox" style="top: 13.2rem;">
                    <h2>2022年7月</h2>
                    <div>
                        <p>发生的事件</p>
...
export default {
  ...
  methods:{
    ...
    slideshow() {
        ...
        function slideOn() {
            boxs[current].className="box active"; //盒子淡入
        }
        ...
        slideshow.onmouseout=function () {
            slideon=setInterval(changeSlide,2000); //当鼠标移出时从新开始轮播事件
        }
        //每2s调用changeSlide函数进行盒子轮播
