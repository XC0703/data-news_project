<template>
  <div>
    <div>
      <el-button type="primary" @click="backMap()" class="btn">返回概览</el-button>
  ...
  methods: {
    ...
    mapChart() {
      ...
      function showProvince(eName,param) {
        ...
        $.getJSON(`/static/map/province/${eName}.json`, data=>{
      ...
      function showCitys(cName, param) {
        ...
        // 显示县级地图
        $.getJSON(`/static/map/city/${cName}.json`, data=>{
          that.$echarts.registerMap(param, data);
          initEcharts(param);
        })
      }
