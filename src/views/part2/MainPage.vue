<template>
    <div class="content">
        <div class="content__word">
            ...
            <p>第二天上午九点，郭艳汝已经做好了准备，接到同事电话以为患者要过来了。</p>
            <p>但是同事在电话那头遗憾地说“患者疼得受不了自杀了”。</p>
            ...
            <p>对郭阿姨因淋巴结堵塞而严重水肿的左臂进行按摩消肿。</p>
            <p>疾病使得阿姨难以准确控制自己的四肢，护士老师就耐心地带着阿姨摸到正确的地方。</p>
            ...
            <p>该报告把各国安宁缓和医疗发展情况分为六个等级：</p>
            <p>1级（没有安宁缓和医疗）、2级（有一定建设努力但尚未建立服务）、</p>
            <p>3A级（提供少量安宁疗护服务）、3B级（提供一般性安宁疗护服务）、</p>
            <p>4A级（安宁疗护纳入主流医疗服务）、4B级（提供广泛全面安宁疗护服务）。</p>
