  ...
  data(){
    return{
        events : [{
            ...
            time:'1994年',
            title:'临终关怀科成为卫生行政部核定医疗诊疗科目登记注册',
            ...
            time:'2006年',
            title:'临终关怀科成为可登记的诊疗科目',
            event:'原卫生部中医药管理局《城市社区卫生服务机构管理办法（试行）》明确：临终关怀科作为可登记的诊疗科目。',
            index:7
        },{
            time:'2011年',
            title:'临终关怀科成为必设科室',
            event:'原国家卫生部颁布《护理院基本标准（2011版）》（卫医政发〔2011〕21号）将临终关怀科作为必设科室，并在现科室增加家属专门陪伴室。临终关怀被纳入护理规划和长期医疗护理服务《中国护理事业发展纲要（2011-2015）》首次将临终关怀纳入护理规划和长期医疗护理服务。',
            index:8
        },{
            time:'2012年',
            ...
            time:'2019年12月23日',
            title:'对医养结合机构安宁疗护工作进行规范',
            event:'12月23日，国家卫健委、民政部、国家医药管理局《关于印发医养结合机构服务指南（试行）》对医养结合机构安宁疗护工作进行规范。',
            index:23
        },{
            time:'2020年',
            ...
            event:'5月，《全国护理事业发展规划（2021-2025年）》指出，加快发展安宁疗护。推动各地按照《安宁疗护中心基本标准和管理规范（试行）》，结合分级诊疗要求和辖区内群众迫切需求，着力增加安宁疗护中心和提供安宁疗护服务的床位数量。制修订《安宁疗护实践指南（试行）》及相关技术标准，不断规范从业人员实践行为。加快培养培训从事安宁疗护服务的专业人员，切实提高生命终末期患者的安宁疗护质量。同时，《“十四五”国民健康规划》指出，我国将稳步扩大全国安宁疗护试点，支持有条件的省市全面开展安宁疗护工作，完善安宁疗护服务模式，建立安宁疗护服务制度体系，提高老年人和疾病终末期患者生命质量。',
            index:26
        },{
            time:'2022年7月',
            title:'优化医疗资源布局',
